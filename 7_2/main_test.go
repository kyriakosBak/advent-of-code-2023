...
func TestIsOnePairWithTrue(t *testing.T) {
	hand := Hand{"A234J", 0}
	result := hand.isOnePair()
...
func TestIsThreeOfAKindWithJTrue(t *testing.T) {
	hand := Hand{"ABAJC", 0}
	result := hand.isThreeOfAKind()
...
func TestIsFullHouseWithJTrue(t *testing.T) {
	hand := Hand{"ABAJB", 0}
	result := hand.isFullHouse()
...
func TestIsFourOfAKindWithJTrue(t *testing.T) {
	hand := Hand{"AAAJB", 0}
	result := hand.isFourOfAKind()
...
func TestIsFiveOfAKindOnlyJIsTrue(t *testing.T) {
	hand := Hand{"JJJJJ", 0}
...
func TestIsFiveOfAKindWithJTrue(t *testing.T) {
	hand := Hand{"AAAAJ", 0}
	result := hand.isFiveOfAKind()
